...
class NerProcessor(DataProcessor):
    ...
    def _create_examples(self,lines,set_type):
        ...
        # with open('create_examples.txt','w',encoding='utf-8')as c:
        #     for i in examples:
        #         for j in str(i.text_a):
        #             c.write(str(j))
        return examples
...
def main():
    ...
    if args.do_train:
        ...
        for _ in trange(int(args.num_train_epochs), desc="Epoch"):
            ...
            bar=enumerate(tqdm(train_dataloader, desc="Iteration"))
    ...
    if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        eval_features, all_tokens = convert_examples_to_features_eval(
        ...
        #     print('tokens:{}'.format(len(all_tokens[i])))
        #     print('y_true:{}'.format(len(y_true[i])))
        #     print('y_pred:{}'.format(len(y_pred[i])))

        generate_result(all_tokens, y_true, y_pred, os.path.join(args.output_dir, "labeled_results.txt"))
